...
#1. Create an Arrauy and traverse.
...
# 6. Add items fromlist into array using fromlist() method
print("Step 6")
tempList = [20,21,22]
my_array.fromlist(tempList)
print(my_array)

# 7. Remove aany array element using remove() method
print("Step 7")
my_array.remove(11)
print(my_array)

# 8. Remove last array elemeent using the pop() method
print("Step 8")
my_array.pop()
print(my_array)
